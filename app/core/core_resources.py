...
from utils.helpers import is_node_ready, calculate_age, get_pod_status
...
class CoreResources:
    ...
    def get_namespaces(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            for ns in namespaces:
                ...
                status = "Active" if phase == "Active" else (
                    "Terminating" if phase == "Terminating" else str(phase) if phase else "Unknown")
    ...
    def get_pods(self, namespace: Optional[str] = None) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error(f"Error getting pods: {e}", exc_info=True)
            return []
    ...
    def get_pod_disruption_budgets(self, namespace: Optional[str] = None) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error(f"Error getting pod disruption budgets: {e}", exc_info=True)
            return []
